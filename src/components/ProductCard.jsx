      ...
      <div className="bg-gray-900 rounded-2xl shadow-xl overflow-hidden flex flex-col h-full transition duration-500 transform border border-gray-800 group hover:scale-[1.03] hover:shadow-orange-900/50 hover:border-orange-500">
        ...
        >
          <img
            src={product.image}
            alt={product.name}
            className="w-full h-56 object-cover object-center transition duration-500 group-hover:scale-105 group-hover:opacity-90 "
          />

          <div className="absolute bottom-0 left-0 bg-orange-600/95 font-extrabold rounded-tr-xl text-white px-5 py-2 text-xl shadow-lg ">
        ...
        <div className="p-5 flex flex-col grow">
          ...
          <div className="flex items-center text-sm text-gray-500 mb-4">
            <span className="bg-gray-800 px-3 py-1 rounded-full border border-gray-700 font-semibold">
              {product.category}
            </span>
          </div>
